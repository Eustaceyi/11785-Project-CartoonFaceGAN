...
identity_criterion = IdentityLoss(coef=10)

optimizer = optim.Adam(cycle_gan.parameters(), lr=1e-3, weight_decay=5e-5)
...
loss = gan_loss_a + gan_loss_b + cycle_loss_a + cycle_loss_b + identity_loss_b + identity_loss_b
loss.backward()
optimizer.step()
